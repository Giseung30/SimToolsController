...
Public Class GamePlugin
    ...
    '////////////////////////////////////////////////
    Private Const _PluginAuthorsName As String = "POMIT"
    Private Const _GameName As String = "SimToolsController" 'GameName (Must Be Unique!) - the displayed Name.
    Private Const _ProcessName As String = "SimToolsController" 'Process_Name without the (".exe") for this game
    ...
    Private Sub UnPatch(MyPath As String)
        If System.IO.File.Exists(MyPath & "\SimToolsController.exe") = True Then
    ...
    Public Sub PatchPathInfo() Implements IPlugin_Game.PatchPathInfo
        ...
        MsgBox("32bit PC's - Please Select Touring Karts Installation Directory." & vbCrLf & "64bit PC's - Please Select Touring Karts Game Save Directory" & vbCrLf & "(64bit's default location is Documents\MyGames\Dirt2).", MsgBoxStyle.OkOnly, "Patching info")
    End Sub
    ...
    Public Function ValidatePatchPath(MyPath As String) As Boolean Implements IPlugin_Game.ValidatePatchPath
        ...
        If System.IO.File.Exists(MyPath & "\SimToolsController.exe") = True Or System.IO.File.Exists(MyPath & "\hardwaresettings\hardware_settings_config.xml") = True Then
            Return True
        Else
            Return False
        End If
